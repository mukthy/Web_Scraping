...
# Sweden Indeed Jobs API Scrapy Starter
def indeed_se(offset, keyword, location, full_name):
    path = '/home/mukthy/Desktop/office/projects/upwork/steam/steamgames'
    subprocess.call(
        [f'scrapy crawl indeed_se -a offset="{offset}" -a keyword="{keyword}" -a location="{location}" -o {full_name}'],
        shell=True, cwd=f'{path}')

    

# Denmark Indeed Jobs API Scrapy Starter
def indeed_dk(offset, keyword, location, full_name):
    path = '/home/mukthy/Desktop/office/projects/upwork/steam/steamgames'
    subprocess.call(
