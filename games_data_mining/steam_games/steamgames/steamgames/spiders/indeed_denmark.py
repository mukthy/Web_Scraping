...
class IndeedUsSpider(scrapy.Spider):
    ...
    start_urls = ['https://dk.indeed.com']
    ...
    def get_indeed_search_url(self, keyword, location, offset):
        ...
        return "https://dk.indeed.com/jobs?" + urlencode(parameters)
    ...
    def parse_search_results(self, response):
        ...
        for index, job in enumerate(jobs_list):
            ...
            job_url = 'https://dk.indeed.com' + job['viewJobLink']
            ...
            if 'companyReviewLink' not in job:
                ...
                company_review_link = 'https://dk.indeed.com' + job['companyReviewLink']
