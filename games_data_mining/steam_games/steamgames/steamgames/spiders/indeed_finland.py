...
class IndeedUsSpider(scrapy.Spider):
    ...
    start_urls = ['https://fi.indeed.com']
    ...
    def get_indeed_search_url(self, keyword, location, offset):
        ...
        return "https://fi.indeed.com/jobs?" + urlencode(parameters)
    ...
    def parse_search_results(self, response):
        ...
        for index, job in enumerate(jobs_list):
            ...
            job_url = 'https://fi.indeed.com' + job['viewJobLink']
            ...
            if 'companyReviewLink' not in job:
                ...
                company_review_link = 'https://fi.indeed.com' + job['companyReviewLink']

            if 'companyBrandingAttributes' not in job:
            ...
            next_page = response.xpath("//a[@data-testid='pagination-page-next']")
